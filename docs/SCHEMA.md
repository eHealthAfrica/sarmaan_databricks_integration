...
- **Mapping CSVs:** the Kobo-column → DB-column mappings are in the repo under `map/amr/`, `map/pharmacy/` and `map/mortality/` (`kobo_name`, `db_name`, `action`, plus `transform` for Mortality). The DB column lists below come from them, in load order. Set `MAP_DIR` to use a different folder.
...
- **Mapping CSVs:** `map/amr/zamfara_household_map.csv`, `zamfara_mother_map.csv` and `zamfara_child_map.csv` rename and drop columns and set the column order. `household_code_pull` / `mother_code_pull` are kept in staging for checking and dropped by the loaders.
...
| Table | Columns, in load order (from `map/amr/`) |
|---|---|
| `amr_household_information` (99 columns) | `id`, `start_time`, `end_time`, `enumerator_name`, `enumerator_phone_number`, `household_head_consent`, `date_of_consent`, `witness`, `witness_name`, `start_timme`, `state`, `lga`, `ward`, `community`, `household_no_category`, `household_consent_name`, `settlement_type`, `language_communication`, `other_language_communication`, `latitude`, `longitude`, `cycle`, `household_number`, `household_code`, `household_status`, `head_household`, `household_name`, `gender_head_household`, `household_age`, `related_to_head_household_name`, `related_to_head_household_live`, `related_to_head_household_stay`, `related_to_head_household_age`, `related_to_head_household_gender`, `related_to_head_household`, `related_to_head_household_others`, `education`, `education_type_quranic`, `education_type_western`, `school_level`, `school_level_primary`, `school_level_secondary`, `school_level_tertiary`, `own_mobile_phone`, `smart_mobile_phone`, `television`, `electric_iron`, `fan`, `refrigerator`, `electricity`, `generator`, `bank_account`, `watch`, `floor_material`, `floor_material_others`, `cooking_stove`, `cooking_stove_others`, `drinking_water_source`, `drinking_water_source_others`, `cooking_water_source`, `cooking_water_source_others`, `no_sleeping_rooms`, `toilet_facility_type`, `toilet_facility_type_others`, `shared_toilet_facility`, `toilet_facility_location`, `waste_disposal`, `waste_disposal_others`, `household_handwash_use`, `household_handwash_use_others`, `household_handwash_observed`, `total_no_persons_household`, `no_wives_0_59_months`, `no_children_0_59_months`, `no_children_1_59_months`, `no_children_0_28_days`, `no_wives_caregivers`, `manifest_url`, `household_uuid`, `end_timme`, `submission_id`, `concatenated_id`, `index`, `health_facility_name`, `marital_status_head_household`, `person_completed_household_questionnaire_signature_url`, `have_phone_number`, `phone_number`, `household_head_occupation`, `donkey`, `truck`, `bicycle`, `tricycle`, `computer`, `table_`, `aircondition`, `wall_material`, `wall_material_others`, `household_number2` |
| `amr_mother_information` (35 columns) | `id`, `state`, `lga`, `ward`, `community`, `mother_id`, `household_code`, `mother_code`, `mother_name`, `mother_age`, `highest_level_education`, `occupation`, `no_children_less_1_month`, `no_children_1_59_month`, `azithromycin_administered`, `no_azithromycin_administered`, `adverse_events`, `excessive_vomiting`, `abdominal_pain`, `excessive_cry`, `watery_stool`, `constipation`, `skin_rash`, `skin_itching`, `adverse_events_other`, `adverse_events_other_specify`, `mother_uuid`, `submission_id`, `concatenated_id`, `index`, `parent_index`, `cycle`, `mother_signature_url`, `father_name`, `mother_marital_status` |
| `amr_child_information` (80 columns) | `id`, `state`, `lga`, `ward`, `community`, `cycle`, `child_id`, `child_code`, `household_code`, `mother_code`, `child_name`, `child_dob`, `child_age`, `child_gender`, `delivery_place`, `feeding_mode_6_months`, `current_feeding_breastfeeding`, `current_feeding_formula`, `current_feeding_family_diet`, `current_feeding_cereals_milk`, `immunization`, `no_immunization`, `child_sick`, `no_ari`, `no_afi`, `no_ad`, `ari_info`, `afi_info`, `ad_info`, `ors_ad`, `zinc_tablet_ad`, `metronidazole_ad`, `probiotics_ad`, `seven_keys_ad`, `septrin_clotrimazole_ad`, `child_antibiotic_ad`, `drug_prescription_ad`, `septrin_clotrimazole_antibiotic`, `penicillin_antibiotic`, `metronidazole_antibiotic`, `erythromycin_antibiotic`, `azithromycin_antibiotic`, `dont_know_antibiotic`, `antibiotic_others`, `antibiotic_others_specify`, `drug_reaction`, `reaction_experienced`, `reaction_experienced_others`, `child_admitted`, `reaction_stop`, `child_used_drug_again`, `child_used_antimalarial_3months`, `drug_prescription_antimalarial`, `name_antimalarial`, `fansidar_antimalarial`, `act_antimalarial`, `chloroquine_antimalarial`, `camosunate_antimalarial`, `quinine_antimalarial`, `antimalarial_dont_know`, `reaction_antimalarial`, `severe_symptom_antimalarial`, `severe_symptom_antimalarial_others`, `hospital_admitted_antimalaria`, `reaction_stopped_antimalarial`, `antimalarial_used_again`, `child_weight`, `child_height_cm`, `sample_date_collected`, `sample_time_collected`, `sample_rectal_swab`, `sample_nasal_swab`, `child_uuid`, `submission_id`, `concatenated_id`, `index`, `parent_index`, `father_name`, `mother_name`, `sample_barcode` |
...
### Transform
- **Mapping:** `map/pharmacy/zamfara_pharmacy_map.csv` (only rows with `action = keep`).
- **LGA:** numeric LGA codes from older form versions are converted to names with `map/pharmacy/zamfara_pharmacy_lga_lookup.csv`. That file was generated from the Pharmacy form's `lga` choice list (codes 01–14, with and without the leading zero).
- **Recodes:**
...
**107 columns**, in load order (from `map/pharmacy/zamfara_pharmacy_map.csv`): `start_time`, `end_time`, `enumerator_name`, `enumerator_phone_number`, `pharmacy_photo_url`, `consent`, `pharmacist_name`, `pharmacist_signature_url`, `date_of_consent`, `witness`, `witness_name`, `start_timme`, `state`, `lga`, `ward`, `latitude`, `longitude`, `pharmacy_number`, `pharmacy_code`, `cycle`, `settlement_type`, `pharmacist_age`, `pharmacist_gender`, `pharmacist_religion`, `pharmacist_religion_other`, `education_type`, `ethnicity_type`, `ethnicity_type_other`, `drug_shop_category`, `drug_shop_category_other`, `prescription_training`, `training_type`, `training_type_other`, `experience_years`, `know_antibiotics`, `define_antibiotics_chest_infections`, `define_antibiotics_treat_sti`, `define_antibiotics_treat_malaria`, `define_antibiotics_kill_germs`, `define_antibiotics_others`, `define_antibiotics_others_specified`, `trained_antibiotics_use`, `trained_antibiotics_use_institution`, `trained_antibiotics_use_institution_specified`, `training_year`, `prescriptions_before_antibiotics`, `prescriptions_before_antibiotics_reason_law`, `prescriptions_before_antibiotics_reason_discourage_misuse`, `prescriptions_before_antibiotics_reason_protect_life`, `prescriptions_before_antibiotics_reason_no_reason`, `prescriptions_before_antibiotics_reason_earn_money`, `prescriptions_before_antibiotics_no_reason_no_reason`, `prescriptions_before_antibiotics_no_reason_no_doctors`, `prescriptions_before_antibiotics_no_reason_desire`, `prescriptions_before_antibiotics_no_reason_recommend`, `prescriptions_before_antibiotics_no_reason_drive_away_clients`, `prescriptions_before_antibiotics_no_reason_others`, `prescriptions_before_antibiotics_no_reason_others_specified`, `people_count_ask_antibitoics`, `people_count_sell_antibitoics_with_prescription`, `people_count_sell_antibitoics_no_prescription`, `sell_less_than_required_antibiotics`, `suspected_conditions_antibiotics_diarrhea`, `suspected_conditions_antibiotics_pain`, `suspected_conditions_antibiotics_uti`, `suspected_conditions_antibiotics_std`, `suspected_conditions_antibiotics_rti`, `suspected_conditions_antibiotics_boil`, `suspected_conditions_antibiotics_fever`, `suspected_conditions_antibiotics_headache`, `suspected_conditions_antibiotics_catarrh`, `suspected_conditions_antibiotics_others`, `suspected_conditions_antibiotics_others_specified`, `combine_antibiotics`, `combine_antibiotics_count`, `antibiotics_prevent_infection`, `specify_antibiotics_prevent_infection`, `specify_other_antibiotics_prevent_infection`, `administer_antibiotic_injections`, `administer_antibiotic_injections_name_amp`, `administer_antibiotic_injections_name_amo`, `administer_antibiotic_injections_name_flagyl`, `administer_antibiotic_injections_name_cipro`, `administer_antibiotic_injections_name_ceftr`, `administer_antibiotic_injections_name_cefur`, `administer_antibiotic_injections_name_genta`, `administer_antibiotic_injections_name_ami`, `administer_antibiotic_injections_name_water`, `administer_antibiotic_injections_name_other`, `administer_antibiotic_injections_name_other_specified`, `days_antibiotics_injection`, `antibiotics_in_shop_amp`, `antibiotics_in_shop_amo`, `antibiotics_in_shop_tetra`, `antibiotics_in_shop_sept`, `antibiotics_in_shop_azith`, `antibiotics_in_shop_eryth`, `antibiotics_in_shop_doxy`, `antibiotics_in_shop_flagyl`, `antibiotics_in_shop_cipro`, `antibiotics_in_shop_thala`, `antibiotics_in_shop_other`, `antibiotics_in_shop_other_specified`, `pharmacy_uuid`, `submission_id`, `concatenated_id`, `index`
...
- **Other columns:** everything else is mapped by `map/mortality/household_map.csv`, `female_map.csv` and `pregnancy_map.csv`. These have the columns `kobo_name`, `db_name`, `action` (keep/review/drop) and `transform`.
